...
setup(
  ...
  version = '2.6.9',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/medImgProc/archive/v2.6.9.tar.gz',    
