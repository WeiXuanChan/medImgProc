...
setup(
  ...
  version = '1.7.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/medImgProc/archive/v1.7.0.tar.gz',    # I explain this later on
