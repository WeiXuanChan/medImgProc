...
setup(
  ...
  version = '2.3.12',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/medImgProc/archive/v2.3.12.tar.gz',    # I explain this later on
  keywords = ['medical', 'image'],   # Keywords that define your package best
  install_requires=['numpy','matplotlib','imageio','scipy','trimesh'],
  extras_require = {
        'auto read dimlen in imread':  ['medpy']
  },
  classifiers=[
