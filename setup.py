...
setup(
  ...
  version = '2.3.4',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/medImgProc/archive/v2.3.4.tar.gz',    # I explain this later on
