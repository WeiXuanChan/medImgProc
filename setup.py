...
setup(
  ...
  version = '2.6.18',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/medImgProc/archive/v2.6.18.tar.gz',    
